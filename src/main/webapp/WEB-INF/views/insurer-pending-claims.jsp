...
<head>
    ...
    <style>
        ...
        .claim-card { background: white; border-radius: 10px; padding: 20px; margin-bottom: 20px; box-shadow: 0 3px 10px rgba(0,0,0,0.05); border-left: 4px solid #ffc107; }
    </style>
</head>
<body>
    <div class="container-custom">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-clock me-2"></i>Pending Claims</h2>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-2">
                                ...
                                | <strong>Date:</strong> <%= claim.getClaimDate() %>
                            </p>
                            <p class="mb-0">
                                <strong>Diagnosis:</strong> <%= claim.getDiagnosisCode() != null ? claim.getDiagnosisCode() : "N/A" %>
                                | <strong>Procedure:</strong> <%= claim.getProcedureCode() != null ? claim.getProcedureCode() : "N/A" %>
                            </p>
                        </div>
                        <div class="col-md-4 text-end">
                            <form action="process/<%= claim.getClaimId() %>" method="POST" class="d-inline">
                                <button type="submit" class="btn btn-success">
                                    <i class="fas fa-calculator me-2"></i>Process Claim
                                </button>
                            </form>
                        </div>
                    </div>
